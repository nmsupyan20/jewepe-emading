...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="index.php">Kelola Artikel /</a></span> Tambah Data</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control" placeholder="Masukkan Judul Artikel" id="exampleFormControlInput1" required />
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="header" class="form-control" id="uploadHeader" required />
