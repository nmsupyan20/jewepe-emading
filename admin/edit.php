...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="index.php">Kelola Artikel /</a></span> Edit Data</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="mb-3">
                                    ...
                                    placeholder="Masukkan Judul Artikel" id="exampleFormControlInput1" 
                            ...
                            <div class="col-lg-3">
                                <div class="col-md mb-3">
                                    ...
                                    <div class="form-check mt-3">
                                        <input name="status_publish" class="form-check-input" type="radio" value="publish" 
                                        id="defaultRadio1" <?= ($data['status_publish'] == 'publish') ? 'checked' : ''; ?> required>
                                    ...
                                    <div class="form-check">
                                        ...
                                        id="defaultRadio2" <?= ($data['status_publish'] == 'draft') ? 'checked' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-danger">Max Size 5 Mb, ext. png, jpg, jpeg</small>
                                </div>
                                <div class="mb-3">
                                    ...
                                    if($data['header'] != ""){ ?>
                                        <a href="../files/<?= $data['header'] ?>" target="_blank">
                                            <img src="../files/<?= $data['header'] ?>" class="img-thumbnail rounded" style="max-width: 160px;">
                                        </a>
                                    <?php } else {
